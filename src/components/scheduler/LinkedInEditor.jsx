...
export default function LinkedInEditor({
  ...
  return (
    <div className="flex flex-col 2xl:flex-row gap-3 font-sans text-[#1D2226]">
      ...
      {/* MIDDLE COLUMN */}
      <div className="flex-1 bg-white rounded-xl p-4 sm:p-6 lg:p-10 overflow-y-auto border border-gray-200">
      ...
      {/* PREVIEW */}
      {/* --- PREVIEW COLUMN --- */}
      <div className="hidden 2xl:block w-[480px] bg-[#F3F5F7] border-l border-gray-200 overflow-y-auto">
