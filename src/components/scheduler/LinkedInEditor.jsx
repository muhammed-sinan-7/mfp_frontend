        ...
        <div className="max-w-xl mx-auto">
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="flex gap-2">
              <label className="flex items-center gap-2 px-4 ml-4 py-2 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-700 hover:bg-gray-50 transition cursor-pointer shadow-sm">
                <input
                  type="file"
                  accept="image/*"
                  className="hidden"
                ...
                <button className="ml-5" onClick={() => window.dispatchEvent(new Event("open-ai"))}>AI</button>
...
<div className="w-[480px] bg-[#F3F5F7] border-l border-gray-200 overflow-y-auto">
  <div className="max-w-[400px] mx-auto py-10 px-4 space-y-6">
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_2px_4px_rgba(0,0,0,0.08)] overflow-hidden">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            <p className="text-[14px] font-bold text-gray-900 truncate leading-tight">
              ...
              <span className="text-gray-500 font-normal text-[12px] ml-1">• 1st</span>
            </p>
      ...
      <div className="px-4 py-2">
        <p className="text-[14px] leading-[1.5] text-[#191919] whitespace-pre-wrap">
          {content || "Your professional update and insights will appear here..."}
        </p>
      </div>
      ...
      <div className="mt-2">
        {previewUrl ? (
          <div className="cursor-pointer">
            <img src={previewUrl} className="w-full h-auto" alt="Post visual" />
            <div className="p-3 bg-[#F9FAFB] border-t border-gray-100">
              <p className="text-[12px] text-gray-500 uppercase font-semibold tracking-tight">SCHEDULEFLOW.IO</p>
          ...
          <div className="aspect-video bg-gray-50 border-y border-gray-100 flex flex-col items-center justify-center">
            <p className="text-[10px] text-gray-300 font-bold uppercase tracking-widest italic">No Media Attached</p>
          </div>
        )}
      </div>
      ...
      <div className="px-3 py-2 flex items-center justify-between border-b border-gray-100 mx-1">
        ...
        <span className="text-[12px] text-gray-500">2 comments • 1 share</span>
      </div>

      <div className="flex items-center justify-between px-2 py-1">
        {[{ label: "Like", icon: <ThumbsUp size={18} /> }, { label: "Comment", icon: <MessageSquare size={18} /> }, { label: "Repost", icon: <Repeat2 size={18} /> }, { label: "Send", icon: <Send size={18} /> }].map((action) => (
          <button key={action.label} className="flex-1 flex items-center justify-center gap-2 py-3 hover:bg-gray-100 rounded text-[#666666] font-semibold text-[14px]">
    ...
    <div className="p-4 bg-white border border-gray-200 rounded-xl flex gap-3 shadow-sm">
      <div className="w-8 h-8 rounded-full bg-blue-50 text-blue-600 flex items-center justify-center font-bold shrink-0">i</div>
